...
import { Linking, SafeAreaView, ScrollView, StatusBar, StyleSheet, Text, TouchableOpacity } from "react-native";
...
const MainScreen = () => {
    const examples: {
        ...
        },
        {
            ...
            onOpen: () => {
                const candyNames = ["Candy 🍬", "Chocolate 🍫", "Lollipop 🍭", "Cookie 🍪", "Cake 🍰", "Ice-cream 🍦", "Doughnut 🍩"];
        ...
        },
        {
            ...
            onOpen: () => {
                SheetManager.show("return-data").then((result) => {
                    ...
                    if (result) {
                        Linking.openURL("https://github.com/ammarahm-ed/react-native-actions-sheet");
                    }
                });
            },
        },
